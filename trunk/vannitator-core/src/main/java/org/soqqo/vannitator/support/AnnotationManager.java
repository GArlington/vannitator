...
public class AnnotationManager {
    ...
    public <T extends Annotation> ConfigBean<T> getConfAnnotation(Class<T> baseVannitationClass, String annotatedClassFQN, String annotationClassFQN) {
        ...
        // if we have the bean already, return it.
        ...
        // don't have it
            ...
            logger.fine("[" + annotatedClassFQN + "] appears not to be annotated with [" + annotationClassFQN + 
                        "] (hint: Have you set the retention policy of the annotation to RUNTIME ? @Retention(RetentionPolicy.RUNTIME))");
            return null;
        }
    }
